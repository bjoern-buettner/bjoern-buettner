...
class MenuList
{
    public static array $en = [
        'home' => ['Home', 'Our start page with a warm welcome to you!',],
        'imprint' => ['Imprint', 'Legal information about the business and the website.',],
        'booking' => ['Booking', 'Book an appointment with us here.',],
        'prices' => ['Offers', 'Our services, offers and prices in a sorted list.',],
        'solutions' => ['Used Solutions', 'Find out what we use to solve your problems.',],
        'ratings' => ['Reviews & Ratings', 'What our customers say about us on Google Maps.',],
        'presentations' => ['Presentations', 'Some presentations about topics we care about.',],
    ...
    public static array $de = [
        ...
        'imprint' => ['Impressum', 'Rechtsinformationen über das Unternehmen und die Webseite.',],
        'booking' => ['Termine', 'Buchen Sie hier einen Termin.',],
        'prices' => ['Leistungen', 'Unsere Serviceleistungen, Angebote und Preise in einer sortierten Liste.',],
        'solutions' => ['Genutzte Lösungen', 'Finden Sie heraus womit wir Ihre Probleme lösen.',],
        'ratings' => ['Bewertungen', 'Was unsere Kunden auf Google-Maps über uns sagen.',],
        'presentations' => ['Präsentationen', 'Einige Präsentationen über Themen die uns wichtig sind.',],
